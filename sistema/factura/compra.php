...
<div id="page_pdf">
	...
	<table id="factura_cliente" style="border-collapse: collapse; width: 100%;">
		<tr style="background-color: #f2f2f2;">
			<td style="padding: 10px;">

				<div class="">
					<center><h3 style="margin: 0;">Datos del Proveedor</h3></center>
	...
	<table id="factura_detalle">
			...
			<tfoot id="detalle_totales">
				...
				<tr>
					<td colspan="2" class="textright"><span>Total de la compra </span></td>
					<td></td>
