	...
	<table id="factura_detalle">
			...
			<tfoot id="detalle_totales">
				...
				<?php 
					...
					$query_cambio = mysqli_query($conection, "SELECT efectivo FROM venta WHERE noventa = $noFactura");
					...
					if ($result_cambio > 0) {                  
						...
						$efectivo = $data_cambio['efectivo'];
					} else {
						// Manejar el caso en el que no se recuperen resultados (opcional)
						$efectivo = "0"; // o asignar un valor predeterminado
				...
				<tr>
					...
					<td class=""><span> <?php echo $moned.' '.number_format($efectivo,2); ?></span></td>
				</tr>
				<?php 
				...
				<tr>
					<td colspan="3" class="textright"><span>Cambio &nbsp;&nbsp;&nbsp; </span></td>
					<td class=""><span> <?php echo $moned.' '.number_format($cambio_dato,2); ?></span></td>
				</tr>
