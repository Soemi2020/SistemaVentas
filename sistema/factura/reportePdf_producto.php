			...
			<tbody id="detalle_productos">
				...
				if ($result_reporte_producto > 0) {
					...
					while ( $data_reporte_porducto = mysqli_fetch_array($query_reporte_producto)) {
							...
							$total_compra_costo += $cantidad * $costo;
					...
					?>
						    <tr id="">
								...
								<td ><?php echo number_format($costo,2).' '.$moned; ?></td>
				...
				<?php
						...
						?>
							...
							<tr>
								...
								<td><span><?php echo number_format($total_compra_costo,2).' '.$moned; ?></span></td>
							</tr>							
							</tfoot>
				<?php
			...
			<tbody id="detalle_productos">
				...
				if ($result_reporte_producto_venta > 0) {
					...
					while ( $data_reporte_porducto_venta = mysqli_fetch_array($query_reporte_producto_venta)) {
							...
							$total_venta_precio +=  $cantidad_venta * $precio;
					...
					?>
						    <tr id="">
								...
								<td ><?php echo number_format($precio,2).' '.$moned; ?></td>
							</tr>
							</tbody>
				<?php
					}					
						?>
							...
							<tr>
								...
								<td><span><?php echo number_format ( $total_venta_precio,2).' '.$moned; ?></span></td>
							</tr>							
							</tfoot>
				<?php
