	...
	<table id="factura_detalle">
			...
			<tfoot id="detalle_totales">
				...
				<tr>
					...
					<td class=""><span> <?php echo number_format ($descuento,2) . ' ' . $moned; ?></span></td>
				</tr>
				<tr>
					<td></td>
					<td></td>
                ...
                <?php 
					...
					$query_cambio = mysqli_query($conection, "SELECT efectivo FROM venta WHERE noventa = $noVenta");
					...
					if ($result_cambio > 0) {                  
						...
						$soe = $data_cambio['efectivo'];
					} else {
						// Manejar el caso en el que no se recuperen resultados (opcional)
						$soe = "0"; // o asignar un valor predeterminado
                ...
                <tr>
					...
					<td class=""><span><?php echo number_format($soe, 2) . ' ' . $moned; ?></span></td>
				</tr>
                <?php 
