<nav>
			<ul>
				...
				?>
						...
						<li><a href="compras.php"><i class="far fa-file-alt fa-w-12"></i> Lista de Compras</a></li>
						<?php  } ?>
					</ul>				
				</li>
				...
				<li class="principal">
					...
					<ul>
						<li><a href="ventas.php"><i class="far fa-file-alt"></i> Lista de venta</a></li>
				...
				<li class="principal">
					<a href="#"><i class="far fa-file-alt"></i> Configuración</a>
					<ul>
				...
				?>
					<ul>
						<li><a href="#" id="estado_resultado"><i class="far fa-file-alt"></i> Estado de Reportes.</a></li>
