...
//Devolucion
    ...
    $('#devolucion_compra').click(function(e){
        e.preventDefault();

        $('.bodyModal').html('<form action="" method="post" name="form_add_product" id="form_add_product" onsubmit="event.preventDefault(); devolucion_compra();">'+                                           
                                            '<h1><i class="fas fa-cube" style="font-size: 45pt;"></i> <br> Devolución compra</h1>'+
                                            '<input type="hidden" name="action" value="devolucion_compra" required>'+
                                            '<label>No. Compra</label>'+
                                            '<input style="text-align:center;" type="text" name="noCompra_dev" id="noCompra_dev" value="" placeholder="No. Compra" required>'+
                                            '<label>Producto</label>'+
                                            '<input style="text-align:center;" type="text" name="codProducto_dev" id="codProducto_dev" value="" placeholder="Código del producto" required>'+
                                            '<label>Cantidad</label>'+
                                            '<input style="text-align:center;" type="number" name="cantProducto_dev" id="cantProducto_dev" value="1" placeholder="" required><br>'+
...
function anularFactura(){
    ...
    $.ajax({
            ...
            {
               if (response == 'error') {
                    $('.alertAddProduct').html('<p style="color:red;">Error al eliminar la venta.</p>');
               }else{
                    $('#row_'+noFactura+' .estado').html('<span class="anulada">Eliminada</span>');
                    ...
                    $('.alertAddProduct').html('<p>Venta elminada.</p>');
               }
            },
            error: function(error){
...
function anularFacturaCompra(){
    ...
    $.ajax({
            ...
            {
               if (response == 'error') {
                    $('.alertAddProduct').html('<p style="color:red;">Se eliminara la compra</p>');
               }else{
                    $('#row_'+noFactura+' .estado').html('<span class="anulada">Eliminada</span>');
                    $('#form_anular_factura .btn_ok').remove();
                    $('#row_'+noFactura+' .div_factura').html('<button type="button" class="btn_anular inactive" ><i class="fas fa-ban"></i></button>');
                    $('.alertAddProduct').html('<p>Compra eliminada correctamente.</p>');
               }
            },
            error: function(error){
...
function generarPDFTicketsoe(cliente,factura){
    var ancho = 1000;
    var alto = 800;
    //Calcularposicion x,y para centrar la ventana
    var x = parseInt((window.screen.width/2) - (ancho / 2));
    ...
    $url = 'factura/soe_ticket_genera_en_lista.php?cl='+cliente+'&f='+factura;
    window.open($url,"Factura","left="+x+",top="+y+",height="+alto+",width="+ancho+",scrollbar=si,location=no,resizable=si,menubar=no");
}
function generarPDFacturasoe(cliente,factura){
    var ancho = 1000;
    var alto = 800;
    //Calcularposicion x,y para centrar la ventana
    var x = parseInt((window.screen.width/2) - (ancho / 2));
    ...
    $url = 'factura/soe_factura_genera_en_lista.php?cl='+cliente+'&f='+factura;
    window.open($url,"Factura","left="+x+",top="+y+",height="+alto+",width="+ancho+",scrollbar=si,location=no,resizable=si,menubar=no");
}
            ...
            //console.log(response);            
                if (response != 'error') {
                    ...
                    $('.bodyModal').html('<form action="" method="post" name="form_add_product" id="form_add_product" onsubmit="event.preventDefault(); eliminarProducto();">'+
                                            ...
                                            '<h1><i class="fas fa-user" style="font-size: 45pt;"></i> <br> Eliminar producto</h1>'+
...
//Modal Form Anular Factura
            ...
            success: function(response){            
                if (response != 'error') {
                   ...
                   $('.bodyModal').html('<form action="" method="post" name="form_anular_factura" id="form_anular_factura" onsubmit="event.preventDefault(); anularFactura();">'+
                                            '<h1><i class="fas fa-cubes" style="font-size: 45pt;"></i> <br> Eliminar Venta</h1><br>'+
                                            ...
                                            '<div class="alert alertAddProduct"></div>'+
                                            '<a href="#" class="btn_cancel" onclick="coloseModal();"><i class="fas fa-ban"></i> Cerrar</a>'+
                                            '<button type="submit" class="btn_ok" onclick="anularVent(); location.reload();"><i class="far fa-trash-alt"></i> Eliminar</button>'  + 
            ...
            success: function(response){            
                if (response != 'error') {
                   ...
                   $('.bodyModal').html('<form action="" method="post" name="form_anular_factura" id="form_anular_factura" onsubmit="event.preventDefault(); anularFacturaCompra();">'+
                                            '<h1><i class="fas fa-cubes" style="font-size: 45pt;"></i> <br> Eliminar Compra</h1><br>'+
                                            '<p>¿Realmente desea eliminar la compra?</p>'+
                                            ...
                                            '<button type="submit" class="btn_ok" onclick="anularCompra(); location.reload();"><i class="far fa-trash-alt"></i> Eliminar</button>'  +   
    ...
    function verFactura(codcliente,nofactura){
        var codCliente = codcliente;
        var noFactura = nofactura;
        generarPDFacturasoe(codCliente,noFactura);
    }
    ...
    function verTicket(codcliente,nofactura){
        var codCliente = codcliente;
        var noFactura = nofactura;
        generarPDFTicketsoe(codCliente,noFactura);
    }
            ...
            success: function(response){            
                if (response != 'error') {
                   ...
                   $('.bodyModal').html('<form action="" method="post" name="form_anular_factura" id="form_anular_factura" onsubmit="event.preventDefault(); anularRecibo();">'+
                                            '<h1><i class="fas fa-cubes" style="font-size: 45pt;"></i> <br> Eliminar Recibo</h1><br>'+
                                            '<p>¿Realmente desea elimnar este recibo?</p>'+
                                            '<p><strong>No. '+info.noventa+'</strong></p>'+
                  ...
                  if (response != 'error')
                     {
                        ...
                        $('#paginadoCajaa').html(info.totales);
            ...
            //console.log(response);            
                if (response != 'error') {
                   ...
                   $('.bodyModal').html('<form action="" method="post" name="form_anular_factura" id="form_anular_factura" onsubmit="event.preventDefault(); anularEgreso();">'+
                                            '<h1><i class="fas fa-cubes" style="font-size: 45pt;"></i> <br> Eliminar Egreso</h1><br>'+
                                            '<p>¿Realmente desea eliminar este egreso?</p>'+
    ...
    $.ajax({
            ...
            success: function(response)
            {
               ...
               if (response == 'error') {
                    ...
                    $('#form_anular_factura .btn_ok').remove();
                    $('.alertAddProduct').html('<p>Egreso eliminado correctamente.</p>');
                    listaGastos('',1,10);
               }
            },
            error: function(error){
