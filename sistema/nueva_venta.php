<?php
    ...
    if(isset($_POST['nombre_cliente'])) {
        ...
        $query_cliente = mysqli_query($conection, "SELECT * FROM cliente WHERE nombre = '$nombre_cliente'");
        ...
        <div style="flex-wrap: wrap;">
            ...
            <div class="data_venta">
                <table class="table_venta">
                    <tr>
                        <td>
                            <input type="hidden" name="idcliente" id="idcliente" placeholder="Nit">
                        ...
                        <td>
                            ...
                            <input type="number" name="descuneto_venta" id="descuneto_venta" value="" disabled placeholder="IVA 16%">
                        ...
                        <td class="textcenter">
                            <div class="wd50">
                                ...
                                <div id="acciones_venta">
                                    <a href="#" class="btn_ok textcenter" id="btn_anular_venta" style="display: <?php echo ($result_caja = 0) ? 'inline-block' : 'none'; ?>;" onclick="event.preventDefault(); anularVent();"><i class="fas fa-ban"></i> Anular</a>
        ...
        $(document).ready(function(){
            ...
            $('#nom_cliente').autocomplete({
                ...
                select: function(event, ui) {
                    var nombre_cliente = ui.item.value;
                    $.ajax({
                        url: 'ajax.php',
                        type: 'POST',
