				...
				<tr>
					<td class="textcenter">
						...
						<div id="acciones_venta">
							...
							<a href="#" class="btn_new textcenter" id="btn_facturar_venta" style="display: none;" title="Procesar" onclick="event.preventDefault();facturar();"><i class="far fa-edit"></i> Procesar</a>
